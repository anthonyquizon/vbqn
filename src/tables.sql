...
create table if not exists vals(id integer primary key autoincrement, ref int, call int, data_index int, type int, foreign key(ref) references refs(id), foreign key(call) references calls(id)); 
